-- Calibration standard / QC check peak area & retention-time trend tracking.
-- Watches Cal Std and QC injections and builds a historical dataset of
-- per-compound RT/area, so drift is visible over time.
