export type LogTypeKey = "material_receipt" | "standard_prep" | "reagent_prep" | "sample_prep" | "qc_prep";

export const LOG_TYPES: { key: LogTypeKey; title: string; description: string }[] = [
  { key: "material_receipt", title: "Material / Lab Supply Receipt Log", description: "Record incoming lab supplies and materials." },
