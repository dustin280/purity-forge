 ...
 * Confirmed with Dustin (2026-08-25): NIB/ICB/CCB are blanks; ICV/CCV
 * verify an already-established calibration curve (a check), not build
 * one, so they're "QC check" rather than "Cal. Std.". LCS/Surrogate would
 * also map to "QC check" but aren't generated by the optimizer yet.
 */
const OPENLAB_SAMPLE_TYPE_FOR_QC_CODE: Record<string, string> = {
  NIB: "Blank", ICB: "Blank", CCB: "Blank",
  ICV: "QC check", CCV: "QC check",
};
