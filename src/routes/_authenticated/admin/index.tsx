...
import { FlaskConical, Users, ChevronRight, ClipboardList, ClipboardCheck } from "lucide-react";
...
const TILES = [
  ...
  { to: "/chain-of-custody", title: "Chain of Custody", desc: "Create and review chain of custody records for received samples.", icon: ClipboardCheck },
