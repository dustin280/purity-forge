    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Tests available for selection on each compound row of the Sample Receipt (e.g. Endotoxin, Heavy Metals, Sterility). Deactivate to hide without losing history.
        </p>
      </div>
