...
import { ChevronRight, PackageCheck, FlaskConical, Gauge, Beaker, Droplets, Clock, Trash2, LineChart, ClipboardCheck, TestTubes, Activity, Radio, ChartLine } from "lucide-react";
...
const ITEMS = [
  ...
  { to: "/lab-logs/pressure-log", title: "Instrument Pressure Log", description: "Continuous pump pressure, flow and column temperature from the live feed, one entry per minute whenever the instrument is on. Review, filter, print, CSV.", icon: ChartLine },
